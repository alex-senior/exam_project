...
file1 = "CLI/labs/lab3/groups/11-CE.txt"
file2 = "CLI/labs/lab3/groups/21-CE.txt"
print(os.getcwd())
...
while True:
  ...
  if user_method.startswith("read"):
    choose_num = input("Виберіть номер файлу для читання(1-2): ")
    check(choose_num)
    match choose_num:
      case '1':
        with open(file1, 'r') as file:
